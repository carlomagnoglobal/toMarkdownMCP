# MCP Test & Validation Results — v0.1.0

Validation evidence for the first public release. All results reproduced from real runs on 2026-07-06 (macOS, Apple Silicon).

## Unit & integration tests

```
$ cargo test
test result: ok. 272 passed; 0 failed; 4 ignored; 0 measured; 0 filtered out
```
